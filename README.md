...
2. **Backend**: Serverless functions with Express
...
Foco principal
Dev 1
Backend (APIs, modelos, autenticação, sorteio, estatísticas)
Dev 2
Backend (WebSocket, tempo real, eventos, campeonato)
Dev 3
Frontend (peladas, sorteio, lista de próximas, rateio)
Dev 4
Frontend (jogo ao vivo, tempo real, campeonato, classificação)
Dev 5 (se houver)
Testes, documentação, deploy, integração
...
O que validar
1-2
Qualquer pessoa consegue se cadastrar como organizador e fazer login?
3-4
Organizador cadastra jogadores? Cria pelada? Adiciona jogadores à lista?
5-6
Sorteio balanceado funciona (diferença ≤ 0.5)? Lista de próximas única? Substituições?
7-8
Cronômetro sincronizado? Registro de gols com assistência? Cartões?
9-10
Estatísticas acumulam? Rateio calculado? Pagamentos marcados?
11-12
Campeonato criado? Tabela gerada? Classificação e artilharia? Sistema publicado?


🎯 Resumo das Funcionalidades por Sprint
Sprint
O que o usuário consegue fazer
1-2
Se cadastrar como organizador
3-4
Cadastrar jogadores, criar pelada, gerenciar lista de inscritos
5-6
Sortear times (aleatório/balanceado), ajustar manualmente, gerenciar lista de próximas
7-8
Acompanhar jogo ao vivo com cronômetro, registrar gols e cartões
9-10
Ver estatísticas dos jogadores, controlar rateio e pagamentos
11-12
Criar campeonato, gerar tabela, acompanhar classificação e artilharia


Este planejamento contempla todas as funcionalidades solicitadas:
✅ Cadastro de organizadores
✅ Gestão de jogadores com nível de estrelas (0.5 em 0.5)
✅ Peladas com lista de inscritos e ordem de chegada
✅ Sorteio balanceado (diferença ≤ 0.5 estrelas)
✅ Lista única de próximas com múltiplos times
✅ Jogo ao vivo com cronômetro sincronizado
✅ Registro de gols, assistências e cartões
✅ Estatísticas individuais acumuladas
✅ Rateio de custos e controle de pagamentos
✅ Campeonatos com múltiplos formatos
✅ Geração automática de tabela sem conflitos
✅ Classificação, artilharia e controle de cartões
